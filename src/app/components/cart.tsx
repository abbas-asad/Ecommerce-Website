...
export default function Cart() {
    ...
    if (cartItems.length === 0) {
        return (
            <Emptycartmessage headingName="Shopping Cart" />
        )
    }
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-3">
                    ...
                    <div className="border border-t-0 rounded-b-lg">
                        {cartItems.map((item) => (
                            <div key={`${item.id}-${item.size || ""}-${item.color || ""}`} className="grid md:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 p-4 items-center border-b last:border-b-0">
