...
interface SpecificProductCardsProps {
    title: string
    subtitle: string
    ...
    return (
        <section className="py-10 relative">
            ...
            <div className="relative">
                ...
                <button
                    onClick={() => scroll("left")}
                    className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 rounded-full p-2 shadow-md flex items-center justify-center hover:bg-white transition-colors"
                ...
                <button
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 rounded-full p-2 shadow-md flex items-center justify-center hover:bg-white transition-colors"
